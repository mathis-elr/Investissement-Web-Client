...
namespace Investissement_WebClient.Application.Services.APIs.PowensApi
{
    public class PowensApiService : IPowensApiService
    {
        ...
        public async Task GetFlux(DateTime dateDebut, DateTime dateFin, int userId)
        {
            ...
            var requete = $"{_accountsEndPoint}/{acces.IdCompteCourant}/transactions?min_date={dateDebutString}&max_date={dateFinString}&limit=500";
