...
namespace Investissement_WebClient.Web.Components.ViewsModels
{
                                              ...
                                              SessionService sessionService)
    {
        ...
        // SIDEBAR
        public IEnumerable<PagesCompteTradeRepublic> Pages = Enum.GetValues<PagesCompteTradeRepublic>();
        public PagesCompteTradeRepublic PageSelectionnee { get; set; } = PagesCompteTradeRepublic.Evolution;
        ...
        public void ChangerContent(PagesCompteTradeRepublic page)
        {
        ...
        public void FinDemandeSynchronisationnchronisation()
        {
            Etat = Etat.Neutre;
            Message = string.Empty;
            DemandeEnCours = false;
            VerificationEnCours = false;
            SynchronisationTransactions = false;
